...
return {
	...
	["normal_nature"] = "<font color='yellow'><b>普通属性</b></font>",
	["fire_nature"] = "<font color='yellow'><b>血属性</b></font>",
	["thunder_nature"] = "<font color='yellow'><b>普通属性</b></font>",
	["xue_nature"] = "<font color='yellow'><b>血属性</b></font>",
	["an_nature"] = "<font color='yellow'><b>暗属性</b></font>",

	["slash-jink"] = "%src 使用了【杀】，请打出一张【闪】",
	["duel-slash"] = "%src 向你【决斗】，你需要打出一张【杀】",
	["savage-assault-slash"] = "%src 使用了【烽火狼烟】，请打出一张【杀】以响应",
	...
	["#TriggerSkill"] = "%from 的被动技<font color='yellow'><b>【%arg】</b></font>被触发",
	...
	["#DamageNoSource2"] = "%to 受到的 <font color='yellow'><b>%arg</b></font> 点伤害<font color='yellow'><b>（%arg2）</b></font>变成了 <font color='red'><b>血量流失</b>",
	["#IronChainDamage"] = "%from 处于合众状态，将受到合众连横传导的伤害",
	["#LoseHp"] = "%from <font color='red'><b>流失了 %arg 点血量</b></font>",

	["#AskForPeaches"] = "%from 向 %to 求药，一共需要 <font color='#98fb98'><b>%arg</b></font> 个药",
	["#Recover"] = "%from <font color='#98fb98'><b>回复了 %arg 点血量</b></font>",
	...
	["#ArmorNullify"] = "%from 的被动技<font color='yellow'><b>【%arg】</b></font>被触发，<font color='yellow'><b>【%arg2】</b></font>对其无效",
	["#SkillAvoid"] = "%from 的被动技<font color='yellow'><b>【%arg】</b></font>被触发，这张 <font color='yellow'><b>%arg2</b></font> 无法指定其为目标",
	["#SkillNullify"] = "%from 的被动技<font color='yellow'><b>【%arg】</b></font>被触发，<font color='yellow'><b>【%arg2】</b></font>对其无效",
	...
	["#LoseMaxHp"] = "%from 流失了 %arg 点血量上限",
	["#LostMaxHpPlus"] = "%from 流失了 %arg 点血量上限，并同时流失了 %arg2 点血量",

	["@askforslash"] = "你可以对你攻击范围内的一名角色使用一张【杀】",
	["@askforretrial"] = "请使用【%dest】技能来修改 %src 的 %arg 判定",

	["#LoseSkill"] = "%from 失去了技能 <font color='yellow'><b>【%arg】</b></font>",
	...
	["3V3arder_mod"] = "3V3休闲模式",
	["fenpei"] = "分配",
	[":fenpei"] = "当你阵亡时，你可以选择将你的所有手牌和装备区的牌以任意分配方式交给其他存活角色。",
	["custom"] = "自定义模式",
	["UnknowNick"] = "英雄",
	["DefaultIllustrator"] = "腾讯",
}
